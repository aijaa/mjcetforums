...
public class TopicWiseAdapter extends RecyclerView.Adapter<TopicWiseAdapter.RecyclerViewHolder>
{
    ...
    public TopicWiseAdapter(ArrayList<Post> arrayList,Context context,String topicName)
    {
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, final int position) {
        try
        {
            final Post feedClass = arrayList.get(position);
            ...
            final String finalQuestionKeey1 = QuestionKeey;
            final String finalQuestionKeey2 = QuestionKeey;
            final String finalQuestionKeey3 = QuestionKeey;
            FirebaseDatabase.getInstance().getReference().child("Tags").child(topicName).
                    child("Posts").child(QuestionKeey)
                    .addValueEventListener(
                            new ValueEventListener() {
                                @Override
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if (dataSnapshot.exists()) {
                                        String hasAnswers = dataSnapshot.child("hasAnswers").getValue().toString();
                                        Log.v("TWAhasA"+" "+feedClass.getQuestionString(),hasAnswers);
                                        if (hasAnswers.equals("true")) {
                                            ...
                                            FirebaseDatabase.getInstance().getReference().child("Answers")
                                                    .child(finalQuestionKeey1).child(feedClass.getAnswerWrittenBy()).child("Upvoters")
                                            ...
                                            holder.UpVoteButton.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    ...
                                                    if (((ToggleButton) v).isChecked()) {
                                                        FirebaseDatabase.getInstance().getReference().child("Answers")
                                                                .child(finalQuestionKeey2).child(feedClass.getAnswerWrittenBy()).child("Upvoters")
                                            ...
                                            FirebaseDatabase.getInstance().getReference().child("Answers")
                                                    .child(finalQuestionKeey3).child(feedClass.getAnswerWrittenBy()).child("Upvoters")
...
//                        if(dataSnapshot.exists())
            ...
            holder.answerButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Post thisQuestion = arrayList.get(position);
